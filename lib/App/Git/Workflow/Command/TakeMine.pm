...
This documentation refers to App::Git::Workflow::Command::TakeMine version 0.0.1


=head1 SYNOPSIS

   use App::Git::Workflow::Command::TakeMine;
...
Return: App::Git::Workflow::Command::TakeMine -
